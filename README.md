...
<img src="logo.png" width="128" height="128" alt="STORM ADDRESSES Logo" />
...
**STORM ADDRESSES** — компонент программного комплекса **STORM**, разработанный с упором на максимальную производительность, современный дизайн и надёжность.
