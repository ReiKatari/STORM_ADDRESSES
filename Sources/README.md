...
<p align="center">
  <b>База адресных данных и геолокационный навигационный менеджер с поисковым индексом.</b>
</p>

[![Version](https://img.shields.io/badge/version-1.0.0-00D2FF.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_ADDRESSES)
[![Platform](https://img.shields.io/badge/Platform-Windows%2011%20%7C%2010-0EA5E9.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_ADDRESSES)
[![Tech](https://img.shields.io/badge/Tech-TypeScript+%2f+Node.js+%2f+Leaflet-6366F1.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_ADDRESSES)
...
**STORM ADDRESSES** — компонент экосистемы **STORM**, разработанный с упором на максимальную производительность, современный дизайн и надёжность.
...
1. Запустите файл STORM_STORM_ADDRESSES_1.0.0_Setup.exe.
2. Выберите режим:
   * **Стандартная установка** — установка в C:\Program Files\STORM ADDRESSES с созданием ярлыков и регистрацией в системе.
